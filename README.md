...
To run any of the commands below get the [fat jar from the releases](https://github.com/simonpoole/preset-utils/releases/tag/0.41.0) in this repository and then run

    java -cp preset-utils-all-0.41.0.jar ch.poole.osm.presetutils.......
  
for example

    java -cp preset-utils-all-0.41.0.jar ch.poole.osm.presetutils.Preset2Pot -h
